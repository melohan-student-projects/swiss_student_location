    ...
    return (
        <div>
            <section className="text-gray-600 body-font">
                        ...
                        {realStates.map((realState: RealState) => (
                            ...
                            <div className="p-4 md:w-1/3" key={realState.id}>
                                <div
                                    ...
                                    <Image src={`/src/assets/images/photos/apartment${realState.id}_1.jpg`} alt="blog" className="lg:h-48 md:h-36 w-full object-cover object-center" />
                                    <div className="p-6">
                ...
                </svg>{realState.rental_properties.rent}
              </span>
                                            <span
