...
export default function InstitutionDropdown() {
    ...
    return (
        <div className="card flex justify-content-center">
            <Dropdown value={selectedInstitution} onChange={(e: DropdownChangeParams) => setSelectedInstitution(e.value as Institution)} options={institutions} optionLabel="name" placeholder="Select an Institution"
                      valueTemplate={selectedInstitutionTemplate} itemTemplate={institutionOptionTemplate} className="w-full md:w-14rem" />
        </div>
    )
}
